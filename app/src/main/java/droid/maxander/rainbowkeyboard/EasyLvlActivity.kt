...
class EasyLvlActivity : AppCompatActivity() {
    private val viewModel: EasyViewModel by lazy {
        ViewModelProvider(this).get(EasyViewModel::class.java)
    }
    ...
    private fun init() {
        binding.easyLevelNumber.text = level.toString()
